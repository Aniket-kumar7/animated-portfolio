...
const Page2 = () => {
    ...
    return (
        ...
        <div id='section' className='w-full text-center bg-white px-0 text-black  flex flex-col justify-center items-center flex-wrap '>
             
            <h1 className='text-gray-500 font-[myfont4] text-xl mt-10'>© Aniket kumar 2025 | design and developed</h1>

        
            <div className='mt-20 rotateText '>
                <h1 className='font-[myfont3] text-[40vw] leading-[35vw] uppercase'>impactful</h1>
            </div>
            <div className='rotateText'>
                <h1 className='font-[myfont3] text-[40vw] leading-[35vw] uppercase'>design</h1>
            </div>
            <div className='rotateText'>
                <h1 className='font-[myfont3] text-[40vw] leading-[35vw] uppercase'> is the </h1>
            </div>
            <div className='rotateText'>
                <h1 className='font-[myfont3] text-[40vw] leading-[35vw] uppercase'>design</h1>
            </div>
            <div className='rotateText'>
                <h1 className='font-[myfont3] text-[40vw] leading-[35vw] uppercase'>that</h1>
            </div>
            <div className='rotateText'>
                <h1 className='font-[myfont3] text-[40vw] leading-[35vw] uppercase'>works!</h1>
            </div>
            <div className='flex justify-center items-center scale-60 w-full'>
